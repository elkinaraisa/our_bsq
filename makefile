...
bsq_main:	check_argc.o check_file.o open_file.o create_int_matrix.o create_struct.o search_square.o print_result.o free_memory.o main.c ft_atoi.o
				gcc -Wall -Wextra -Werror -o bsq_main check_argc.c check_file.c open_file.c create_int_matrix.c create_struct.o search_square.o print_result.o free_memory.o ft_atoi.o main.c
